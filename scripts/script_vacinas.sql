...
insert into vacina(nome,paisOrigem,estagioPesquisa,dtInicioPesquisa,dtTerminoPesquisa,quantidadeDoses, idCriador) values("Sputnic","Russia","Final", '2020-05-05', '2021-01-05', 200, 1);
...
insert into pesquisador(instituicao, fkIdPessoa) values("Apocalipse", 1);
